...
public class Restaurant_ implements Serializable {
    ...
    public String toString() {
        return "Adres: "+getLocation().getAddress()+
                "\n\n2 Kişi İçin Ortalama Fiyat: "+getAverageCostForTwo()+
                "\n\nYemek Türü: "+getCuisines()+
                "\n\nPara Birimi: "+getCurrency()+
                "\n\nToplam Oylama "+userRating.aggregateRating+
